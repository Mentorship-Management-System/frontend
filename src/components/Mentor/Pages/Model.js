...
const Model = ({
  ...
  const approveHandler = () => {
    ...
    const index = temp_meetings.findIndex(
      (obj) => obj.meeting_id === new_meeting.meeting_id
    );
    ...
    approve_meeting(mentor.token, mentor.mentor_id, meeting.meeting_id)
      ...
      .finally(() => {
        setOpenModal(
          meeting.meeting_id === openmodal ? null : meeting.meeting_id
        );
      });
  };
  return (
          ...
          <div className={styles.modalContent}>
              ...
              <Stack spacing={4}>
                ...
                <Text>
                  ...
                  <i>
                    {meeting?.feedback
                      ? meeting?.feedback
                      : "No feedback from the student(s) yet."}
                  </i>
                </Text>
                {/* <Box>
            ...
            <Flex justify="flex-end" gap="10px" mt="3%">
              <Button
                ...
                display={meeting.approve ? "none" : "inline-block"}
              >
                Approve Meeting
              </Button>
            </Flex>
